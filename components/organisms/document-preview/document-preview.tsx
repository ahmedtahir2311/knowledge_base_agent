...
import type {
  ArtifactKind,
  UIArtifact,
} from "@/components/artifacts/definitions";
import { CodeEditor } from "@/components/organisms/code-editor";
import {
  DocumentToolCall,
  DocumentToolResult,
} from "@/components/molecules/document-tool-parts";
import { InlineDocumentSkeleton } from "@/components/molecules/document-skeleton";
import { FileIcon, FullscreenIcon, ImageIcon, LoaderIcon } from "lucide-react";
import { ImageEditor } from "@/components/organisms/editors/image-editor";
import { SpreadsheetEditor } from "@/components/organisms/editors/sheet-editor";
import { Editor } from "@/components/organisms/editors/text-editor";
