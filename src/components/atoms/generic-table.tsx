              ...
              ${Math.min(
                ...
                {totalPages > 1 && (
                    <div className='flex items-center gap-1'>
                        <button
                            className={`p-1 rounded-md  border border-gray-100 ${!table.getCanPreviousPage()
                        ...
                        <div className='flex gap-1'>
                            {generatePageNumbers().map((pageNumber, index) => (
                                <button
                                    key={index}
                                    className={`min-w-[2rem] h-8 rounded-md cursor-pointer ${pageNumber === currentPage
                        ...
                        <button
                            className={`p-1 rounded-md border border-gray-100 ${!table.getCanNextPage()
                                    ? "opacity-50 cursor-not-allowed"
                                    : "hover:bg-gray-100 cursor-pointer"
                                }`}
